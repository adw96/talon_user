...
formatters_dict = {
    ...
    # "SPACE_REGULAR": (SEP, lambda i, word, _: word),
    # "SPACE_REGULAR": (SEP, surround(" ")),
    "SPACE_REGULAR": (
        SEP,
...
formatters_words = {
    ...
    "yellow": formatters_dict["ALL_CAPS"],
    "yeller": formatters_dict["ALL_CAPS"],
    "space": formatters_dict["SPACE_REGULAR"],
    # "all down": formatters_dict["ALL_LOWERCASE"],
    "lowpoe": formatters_dict["ALL_LOWERCASE"],
    "camel": formatters_dict["PRIVATE_CAMEL_CASE"],
    "dotted": formatters_dict["DOT_SEPARATED"],
    "dub string": formatters_dict["DOUBLE_QUOTED_STRING"],
    # "dunder": formatters_dict["DOUBLE_UNDERSCORE"],
    "crunder": formatters_dict["DOUBLE_UNDERSCORE"],
    ...
    "slashway": formatters_dict["SLASH_SEPARATED"],
...
ctx.lists["self.prose_formatter"] = {
    # Amy edited October 27, 2022
    # "say": "NOOP",
    # "speak": "NOOP",
    # "sento": "CAPITALIZE_FIRST_WORD",
}
