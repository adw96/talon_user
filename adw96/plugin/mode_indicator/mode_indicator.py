...
# from talon import Module, app, registry, scope, settings, skia, ui, actions
# from talon.canvas import Canvas
# from talon.screen import Screen
# from talon.skia.canvas import Canvas as SkiaCanvas
# from talon.skia.imagefilter import ImageFilter
...
# mod.setting("mode_indicator_color_command", type=str)
# mod.setting("mode_indicator_color_other", type=str)
# mod.setting("mode_indicator_color_muted", type=str)
# mod.setting("mode_indicator_color_listening", type=str)
...
#     "user.mode_indicator_color_command",
#     "user.mode_indicator_color_other",
#     "user.mode_indicator_color_muted",
#     "user.mode_indicator_color_listening",
# }
...
#         return settings.get("user.mode_indicator_color_sleep")
#     else:
#         if active == "SpeechWare USB MultiAdapter":
#             return settings.get("user.mode_indicator_color_listening")
#         elif active == "None":
#             return settings.get("user.mode_indicator_color_muted")
#         else: 
#             return settings.get("user.mode_indicator_color_command") 
#     # else:
#     #     if current_mode == "sleep":
