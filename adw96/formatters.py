...
formatters_dict = {
    ...
    "SPACE_STARTING_STRING": (SEP, first_vs_rest(lambda w: " " + w)),
    "COMMA_SPACE_STARTING_STRING": (SEP, first_vs_rest(lambda w: ", " + w)),
...
formatters_words = {
    "yellow | yeller": formatters_dict["ALL_CAPS"],
    "allcaps": formatters_dict["ALL_CAPS"],
    "loper | lowpoe": formatters_dict["ALL_LOWERCASE"],
    ...
    "sento": formatters_dict["CAPITALIZE_FIRST_WORD"],
    "sento her": formatters_dict["CAPITALIZE_FIRST_WORD"],
    # "slasher": formatters_dict["SLASH_SEPARATED"],
    "smash": formatters_dict["NO_SPACES"],
    "snake": formatters_dict["SNAKE_CASE"],
    # "speak": formatters_dict["NOOP"],
    "space": formatters_dict["SPACE_STARTING_STRING"],
    "spine": formatters_dict["DASH_SEPARATED"],
    "swipe": formatters_dict["COMMA_SPACE_STARTING_STRING"],
    "string": formatters_dict["SINGLE_QUOTED_STRING"],
    "tiptoe": formatters_dict["CAPITALIZE_ALL_WORDS"],
}
