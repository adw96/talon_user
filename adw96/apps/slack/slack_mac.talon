...
insert meow party: insert(":meow_party: ")
insert meow dance: insert(":meow_dance: ")
insert meow clubbing: insert(":meow_clubbing: ")
insert meow trampoline: insert(":meow_trampoline: ")
insert meow blush: insert(":meow_blush: ")
insert meow wow: insert(":meow_wow: ")
